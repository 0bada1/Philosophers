...
/*   Updated: 2023/05/23 14:26:55 by ooutabac         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_node	*parsing(int argc, char *argv[])
{
	...
	if ((int)philos->num_of_philos == -1 || (int)philos->time_to_die == -1 || (int)philos->time_to_eat == -1 || (int)philos->time_to_sleep == -1 || (int)philos->number_of_times_to_eat == -1)
